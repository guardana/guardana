...
gh attestation verify oci://ghcr.io/guardana/guardana:0.10 --repo guardana/guardana
docker buildx imagetools inspect ghcr.io/guardana/guardana:0.10 --format '{{ json .SBOM }}'
```
...
Guardana is pre-1.0 (0.10.x). Security fixes land on the latest released
