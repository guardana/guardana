...
gh attestation verify oci://ghcr.io/guardana/guardana:0.23 --repo guardana/guardana
docker buildx imagetools inspect ghcr.io/guardana/guardana:0.23 --format '{{ json .SBOM }}'
```
...
Guardana is pre-1.0 (0.23.x). Security fixes land on the latest released
