...
gh attestation verify oci://ghcr.io/guardana/guardana:0.9 --repo guardana/guardana
docker buildx imagetools inspect ghcr.io/guardana/guardana:0.9 --format '{{ json .SBOM }}'
```
...
Guardana is pre-1.0 (0.9.x). Security fixes land on the latest released
