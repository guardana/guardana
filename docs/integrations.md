...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.10   # moving tag; pins to the latest 0.10.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.10/deploy/ci/gitlab-ci.yml"
