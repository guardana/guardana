...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.17   # moving tag; pins to the latest 0.17.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.17/deploy/ci/gitlab-ci.yml"
