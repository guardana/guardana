...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.18   # moving tag; pins to the latest 0.18.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.18/deploy/ci/gitlab-ci.yml"
