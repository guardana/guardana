...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.20   # moving tag; pins to the latest 0.20.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.20/deploy/ci/gitlab-ci.yml"
