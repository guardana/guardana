...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.16   # moving tag; pins to the latest 0.16.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.16/deploy/ci/gitlab-ci.yml"
