...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.15   # moving tag; pins to the latest 0.15.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.15/deploy/ci/gitlab-ci.yml"
