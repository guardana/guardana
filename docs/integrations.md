...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.21   # moving tag; pins to the latest 0.21.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.21/deploy/ci/gitlab-ci.yml"
