...
jobs:
  guardana:
    ...
    steps:
      ...
      - uses: guardana/guardana@v0.19   # moving tag; pins to the latest 0.19.x
        with:
          path: .
...
```yaml
include:
  - remote: "https://raw.githubusercontent.com/guardana/guardana/v0.19/deploy/ci/gitlab-ci.yml"
