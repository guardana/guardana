...
```bash
docker run --rm -v "$PWD:/work:ro" ghcr.io/guardana/guardana:0.19 \
...
docker run --rm -v "$PWD:/work" \
  ...
  ghcr.io/guardana/guardana:0.19 \
...
```bash
docker run --rm -v "$PWD:/work" ghcr.io/guardana/guardana:0.19 scan /work || true
```
