...
```bash
docker run --rm -v "$PWD:/work:ro" ghcr.io/guardana/guardana:0.17 \
...
docker run --rm -v "$PWD:/work" \
  ...
  ghcr.io/guardana/guardana:0.17 \
...
```bash
docker run --rm -v "$PWD:/work" ghcr.io/guardana/guardana:0.17 scan /work || true
```
