...
```bash
docker run --rm -v "$PWD:/work:ro" ghcr.io/guardana/guardana:0.16 \
...
docker run --rm -v "$PWD:/work" \
  ...
  ghcr.io/guardana/guardana:0.16 \
...
```bash
docker run --rm -v "$PWD:/work" ghcr.io/guardana/guardana:0.16 scan /work || true
```
