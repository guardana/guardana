...
def test_writing_a_pin_records_the_manifest_and_reports_the_count(
    ...
    monkeypatch.setattr(
        ...
        lambda connection: McpServerTarget("https://x", transport=_Fake(_TOOLS["tools"])),  # type: ignore[arg-type]
    )
